...
class VAE(nn.Module):
    def __init__(self, nc=1, ngf=128, ndf=128, latent_variable_size=128,imsize=64,lamb=0.0001,batchnorm=True):
        ...
        self.loss_names = ['recon_loss', 'loss','kl_loss'] #,'clf_loss']
...
class CVAE(VAE):
    def __init__(self, nc=1, ngf=128, ndf=128, latent_variable_size=128, imsize=64, lamb=0.0001, lamb2=0.0001, batchnorm=True):
        super(CVAE, self).__init__(nc, ngf, ndf, latent_variable_size, imsize, lamb, batchnorm)
        self.lamb2 = lamb2
